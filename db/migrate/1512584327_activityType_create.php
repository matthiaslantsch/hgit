 ...
 * (c) Matthias Lantsch
 *
 * class file for a migration to create the activityType table
 *
 ...
 */
class ActivityTypeCreateMigration implements Migration {

	/**
	 * migration into the up direction
	 */
	public static function up() {
		Schema::createTable('activityType', function($t) {
			$t->string("name")->size('10');
			$t->version("1512584327");
		});
	}
